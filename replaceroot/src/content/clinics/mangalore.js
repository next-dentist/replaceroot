...
const mangalore = {
  ...
  pridePoints: [
    'Mangalore-focused digital planning and diagnostics for precise implant placement',
  ...
  whyFeatures: [
    { icon: 'fa-crown', title: 'Implant-Focused Care', description: 'Complete implant solutions from single-tooth to full-mouth in Mangalore.' },
    { icon: 'fa-user-md', title: 'Expert Team', description: 'Predictable outcomes for complex and atrophic jaw cases.' },
    { icon: 'fa-map-marker-alt', title: 'Convenient Location', description: 'Accessible Mangalore address with easy approach and parking.' },
  ...
  innovation: {
    excellence: 'Our Mangalore center is renowned for its exceptional success rates and patient satisfaction in dental implant procedures, backed by years of proven results and happy patients.',
    technology: 'We utilize state-of-the-art 3D imaging and computer-guided implant placement technology to ensure precision and optimal results for every patient in Mangalore.'
  },
  ...shared
};
