const WhyChooseBahraich = () => {
  const features = [
    {
      icon: 'fa-bullseye',
      title: 'Only Implants Oriented Approach',
      description: 'Our purpose-designed and custom-built clinic in Bahraich lets us provide you acme equipment Implants in pleasant, comfortable surroundings.'
    },
    {
      icon: 'fa-user-md',
      title: 'Most skillful Implant Experts',
      description: 'All of the dentists at Replace Roots in Bahraich are excited about their work and are focused to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-map-marker-alt',
      title: 'Centrally Located',
      description: 'Find us quickly and easily. Replace Roots, is in the central of Bahraich in the progressive city Area, within walking distance of near bus stop and other public transports.'
    },
    {
      icon: 'fa-clock',
    ...
    },
    {
      ...
      description: 'Are of paramount importance at Replace Roots, Bahraich. We are beset with cleanliness, have a dedicated decontamination room, and follow rigorous guidelines to ensure patient safety.'
    },
    {
      icon: 'fa-users',
      title: 'Staff',
        ...
        <div className="text-center">
          <div className="relative mb-16 flex justify-center">
            <h2 className="text-4xl font-semibold text-gray-800 pb-3 relative text-center">
              Why Bahraich for Dental Implants?
...
export default WhyChooseBahraich;
