    ...
    <>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className={`absolute top-full left-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2`}>
                  <div className="p-4">
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-800 mb-3 border-b border-gray-100 pb-2">Dental Implant Services</h4>
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-gray-800 mb-3 border-b border-gray-100 pb-2">Dental Implant Leads</h4>
      ...
      {isMobileMenuOpen && (
          ...
          <nav className="px-4 pt-2 pb-4 space-y-2">
              ...
              <Link to="/pricing" className="block text-gray-600 hover:text-cyan-600 transition-all duration-300 py-2">Pricing / Plans</Link>
