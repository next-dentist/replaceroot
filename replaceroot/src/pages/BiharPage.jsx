...
const BiharPage = () => {
  const clinicName = 'amaravati';
  const displayCity = 'Bihar Sharif';
  ...
  const pridePoints = [
    'Using the acme range of implant fittings',
    'Using the best local dental experts',
    'Never pliant on the quality of the attachments we use',
    'Detailed dental Implant treatment',
    'Handy & staffs',
  ...
  const whyFeatures = [
    {
      ...
      description:
        'Our purpose-designed and custom-built clinic in Bihar Sharif lets us provide you acme attachments Implants in pleasant, comfortable surroundings.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Most skillful Implant Experts',
      description:
        'All of the dentists at Replace Roots in Bihar Sharif are passionate about their work and are serious to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Centrally Located',
      description:
        'Find us quickly and easily. Replace Roots, is in the middle of Bihar Sharif in the productive city Area, within walking distance of near bus stop and other public transports.'
    },
    {
      icon: 'fa-check-circle',
    ...
    },
    {
      ...
      description:
        'Are of paramount importance at Replace Roots, Bihar Sharif. We are beset with cleanliness, have a dedicated decontamination room, and follow rigorous guidelines to ensure patient safety.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Staff',
  ...
  const benefits = [
    ...
    },
    {
      ...
      items: ['Teeth in a Day choice', 'Quick Solution', 'No waiting Time']
    }
  ];
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              <div className="text-center md:text-left">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6">
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">{displayCity}</span>
                </h1>
                
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0">
                  Approved ReplaceRoots Dental Implant centre in Bihar Sharif is the most treatment choice for replacing absent teeth. Rather than using traditional denture and teeth in fixed bridges. We offer the best techniques in Dental implants in the Bihar Sharif branch. Whatever the reason for absent teeth was, Replace Roots dental centre could cover the way to a courageous new smile.
                </p>
                ...
                <div className="flex items-center justify-center mb-6">
                  ...
                  <div className="relative">
                    <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 inline-block pb-3 relative">
                      At our branch at {displayCity}, <span className="text-teal-500">we pride ourselves on:</span>
                ...
                <div className="order-2 lg:order-1">
                  <div className="relative">
                    <img 
                      ...
                      alt={`Dental Clinic in ${displayCity} - Premium Care`} 
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 sm:mb-6">
                 How Much Do Dental Implants Cost in <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">{displayCity}</span>?
              </h2>
              ...
              <p className="max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-4">
                A full mouth dental implant procedure can cost in Bihar Sharif between 450,000 INR and 900,000 INR($6500 to $10000). It also depends upon several factors like Type of Implant, difficulty of the case, and time of Treatment.
              </p>
            </div>
            ...
            <div className="container mx-auto px-6">
              <div className="text-center mb-12">
                <div className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-cyan-100 to-teal-100 text-cyan-700 rounded-full text-xs sm:text-sm font-medium mb-4"><i className="fa-solid fa-user-doctor mr-2"></i>Dental Experts</div>
                 <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Dental Implant's experts <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">in {displayCity}</span></h2>
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-10 items-start">
              <div>
                <div className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-cyan-100 to-teal-100 text-cyan-700 rounded-full text-xs sm:text-sm font-medium mb-4"><i className="fa-solid fa-plane-departure mr-2"></i>Dental Tourism</div>
                 <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Dental Tourism <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">in {displayCity}</span></h2>
        ...
        <section id="contact" className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 sm:mb-6">
                 Contact us at <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">{displayCity}</span>
              </h2>
              ...
              <div className="relative">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                  ...
                  <iframe 
                    ...
                    title={`${displayCity} Location Map`}
                    className="w-full"
                  />
                </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16 mt-12">
                ...
                <div className="flex items-center justify-center mb-4 sm:mb-6">
                  <i className="fa-solid fa-tooth text-teal-500 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">
                    Other Implants Treatments <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">at {displayCity}</span>
                  </h2>
                </div>
                <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-cyan-500 to-teal-500 mx-auto rounded-full"></div>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                   Causes why implant treatment is increasing in <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">{displayCity}</span>?
                </h2>
                  ...
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      <div className="flex items-center mb-6">
                       ...
                       <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Reliability and prestige have been achieved through research and novelty, service, and quality control. The Replace Roots Centre in Bihar Sharif is the most checked, the most common, and may be considered a reference Clinic.</p>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      <div className="flex items-center mb-6">
                       ...
                       <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Currently, there is many of implant systems and components to satisfy most surgical and restorative situations. Modern dental implant systems comprise a comprehensive array of precision instruments, components, interactive software, and techniques for the creation of implant revivals. </p>
                    </div>
                  </div>
                </div>
