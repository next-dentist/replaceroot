...
const MuzaffarpurPage = () => {
  const clinicName = 'muzaffarpur';
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-muzaffarpur"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative z-10">
                  <img 
                    src="/images/Muzaffarpur/a1.webp" 
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 lg:order-1">
                  <div className="relative">
                    <img 
                      src="/images/Muzaffarpur/a2.webp" 
...
export default MuzaffarpurPage;
