...
const MangalorePage = () => {
  const clinicName = 'mangalore';
  const displayName = getDisplayName(clinicName);
  const displayCity = 'Mangalore';
  ...
  return (
    <Layout
      ...
      keywords={['dental implants in Mangalore', `best dental clinic in ${displayCity}`, 'teeth implants Mangalore', 'All-on-4 Mangalore', 'affordable dental implants Mangalore', 'permanent teeth replacement Mangalore', 'ReplaceRoots Mangalore']}
      canonical="/dental-implants-mangalore"
      og={{
