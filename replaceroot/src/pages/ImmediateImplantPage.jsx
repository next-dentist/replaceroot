              ...
              <div className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-2xl p-8 border border-cyan-200">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Single appointment procedure</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-check-circle text-green-500 mt-1"></i>
                    <span className="text-gray-700">Same-day results</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-check-circle text-green-500 mt-1"></i>
                    <span className="text-gray-700">Preserves bone structure</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-check-circle text-green-500 mt-1"></i>
                  ...
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-check-circle text-green-500 mt-1"></i>
                    <span className="text-gray-700">Faster overall treatment</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-check-circle text-green-500 mt-1"></i>
                    <span className="text-gray-700">Reduced discomfort</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-8 border border-gray-300">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Multiple appointments required</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-times-circle text-red-500 mt-1"></i>
                    <span className="text-gray-700">3-6 month waiting period</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-times-circle text-red-500 mt-1"></i>
                    <span className="text-gray-700">Potential bone loss</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-times-circle text-red-500 mt-1"></i>
                    <span className="text-gray-700">Extended treatment time</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-times-circle text-red-500 mt-1"></i>
                    <span className="text-gray-700">Multiple surgical procedures</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <i className="fa-solid fa-times-circle text-red-500 mt-1"></i>
                    <span className="text-gray-700">More overall discomfort</span>
                  </li>
                </ul>
              </div>
            </div>
