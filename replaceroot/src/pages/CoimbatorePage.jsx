...
const CoimbatorePage = () => {
  const clinicName = 'coimbatore';
  const displayName = getDisplayName(clinicName);
  const displayCity = 'Coimbatore';
  ...
  const pridePoints = [
    'Using the best range of implant fittings',
    'Using the best local dental specialists',
    'Never pliant on the quality of the equipment we use',
    'Excellent dental Implant treatment',
    'Kind & Valuable staffs',
    'Comfortable & Applicable setting',
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0">
                  <title>Dental Implants in Coimbatore | Best Implant Clinic | ReplaceRoots</title>
                  <meta name="description" content={`Best dental implants in Coimbatore at ReplaceRoots. Pain-free, affordable & permanent teeth replacement solutions. Book a free consultation with our expert dentists today!`} />
                  <meta name="keywords" content={`dental implants in Coimbatore, best dental clinic in Coimbatore, teeth implants Coimbatore, All-on-4 Coimbatore, affordable dental implants Coimbatore, permanent teeth replacement Coimbatore, ReplaceRoots Coimbatore`} />
                  <meta property="og:title" content={`Dental Implants in Coimbatore | Best Implant Clinic | ReplaceRoots`} />
                  <meta property="og:description" content={`Get world-class dental implants in Coimbatore at ReplaceRoots. Pain-free procedures, affordable pricing, and expert care for permanent teeth replacement solutions.`} />
                  <meta property="og:type" content="website" />
                  <meta property="og:image" content={clinic.prideImage || clinic.hero.image} />
                  <meta name="twitter:card" content="summary_large_image" />
                  <link rel="canonical" href="/dental-implants-coimbatore" />
                  Approved ReplaceRoots Dental Implant center in Coimbatore is the most useful treatment variant for replacing absent teeth. Rather than using traditional denture and nearby teeth in fixed bridges. We offer the best techniques in Dental implants in the Coimbatore branch. Whatever the causes for absent teeth was, Replace Roots dental center could cover the way to a confident new smile.
                </p>
                ...
                <div className="flex items-center justify-center mb-6">
                  ...
                  <div className="relative">
                    <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 inline-block pb-3 relative">
                      At our center at {displayCity}, <span className="text-teal-500">we pride ourselves on:</span>
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-4">
                A full mouth dental implant procedure can cost in Coimbatore between 450,000 INR and 900,000 INR($6500 to $10000). It also depends upon several factors like Type of Implant, Complexity of the case, and time of Treatment.
              </p>
            </div>
