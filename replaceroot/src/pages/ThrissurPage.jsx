...
const ThrissurPage = () => {
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-thrissur"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
    ...
    <div className="font-inter bg-gray-50 text-gray-700">
      ...
      <main>
                  ...
                  <div className="flex items-center space-x-4 sm:space-x-6">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-xl sm:text-2xl font-bold text-teal-600 hover:underline"
                      >
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-center space-x-4 sm:space-x-6">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clinic.contact.email}`} className="text-lg sm:text-xl text-gray-700 hover:underline">
        ...
        {/* Innovation Section */}
        {clinic.innovation && (clinic.innovation.excellence || clinic.innovation.technology) && (
        <section className="py-24 bg-gradient-to-br from-white to-gray-50 relative overflow-hidden">
