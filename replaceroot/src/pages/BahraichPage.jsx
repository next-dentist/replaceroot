...
const BahraichPage = () => {
  ...
  const pridePoints = [
    'Using the acme range of implant facilities',
    'Using the best local dental technicians',
    'Never yielding on the quality of the equipment we use',
    'Prime dental Implant treatment',
    'Friendly & staffs',
    'Comfortable & Convenient setting',
    'Highly experienced dental operator'
  ];
  ...
  const whyFeatures = [
    {
      ...
      description:
        'Our purpose-designed and custom-built clinic in Bahraich lets us provide you acme equipment Implants in pleasant, comfortable surroundings.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Most skillful Implant Experts',
      description:
        'All of the dentists at Replace Roots in Bahraich are excited about their work and are focused to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Centrally Located',
      description:
        'Find us quickly and easily. Replace Roots, is in the central of Bahraich in the progressive city Area, within walking distance of near bus stop and other public transports.'
    },
    {
      icon: 'fa-check-circle',
    ...
    },
    {
      ...
      description:
        'Are of paramount importance at Replace Roots, Bahraich. We are beset with cleanliness, have a dedicated decontamination room, and follow rigorous guidelines to ensure patient safety.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Staff',
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0">
                  Approved ReplaceRoots Dental Implant branch in Bahraich is the most convenient treatment choice for replacing loss teeth. Rather than using traditional denture and teeth in fixed bridges. We offer the best techniques in Dental implants in the Bahraich branch. Whatever the reason for loss teeth was, Replace Roots dental branch could cover the way to a positive new smile.
                </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-4">
                A full mouth dental implant procedure can cost in Bahraich between 450,000 INR and 900,000 INR($6500 to $10000). It also depends upon several factors like Type of Implant, Complexity of the case, and time of Treatment.
              </p>
            </div>
                ...
                <div className="space-y-8">
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Credibility and reputation have been achieved through research and variation, service, and quality control. The Replace Roots Centre in Bahraich is the most searched, the most accepted, and may be considered a reference Clinic.</p>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Currently, there is of implant systems and components to satisfy most surgical and restorative situations. Modern dental implant systems include a comprehensive array of accuracy instruments, components, interactive software, and techniques for the creation of implant regenerations.</p>
                    </div>
                  </div>
                </div>
