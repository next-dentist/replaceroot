...
const SiliguriPage = () => {
  const clinicName = 'siliguri';
  const displayName = getDisplayName(clinicName);
  const displayCity = 'Siliguri';
  ...
  return (
    <Layout
      ...
      keywords={['dental implants in Siliguri', `best dental clinic in ${displayCity}`, 'teeth implants Siliguri', 'All-on-4 Siliguri', 'affordable dental implants Siliguri', 'permanent teeth replacement Siliguri', 'ReplaceRoots Siliguri']}
      canonical="/dental-implants-siliguri"
      og={{
