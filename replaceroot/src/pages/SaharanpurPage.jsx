...
const SaharanpurPage = () => {
  const clinicName = 'saharanpur';
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-saharanpur"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
