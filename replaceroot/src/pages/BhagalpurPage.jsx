...
const BhagalpurPage = () => {
  ...
  const pridePoints = [
    'Using the better range of implant accessories',
    'Using the best local dental surgeon',
    'Never compromising on the quality of the fittings we use',
    'Total dental Implant treatment',
    'Considerate & staffs',
    'Comfortable & Spacious setting',
    'Highly experienced dental surgeon'
  ];
  ...
  const whyFeatures = [
    ...
    {
      icon: 'fa-check-circle',
      title: 'Most skilled Implant Experts',
      description:
        'All of the dentists at ReplaceRoots in Bhagalpur are ardent about their work and are focused to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-check-circle',
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-4">
                A full mouth dental implant procedure can cost in Bhagalpur between 450,000 INR and 900,000 INR($6500 to $10000). It also depends upon several factors like Type of Implant, obscurity of the case, and time of Treatment.
              </p>
            </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Currently, there is enough of implant systems and components to satisfy most surgical and restorative situations. Modern dental implant systems comprise a comprehensive array of exactness instruments, components, interactive software, and techniques for the creation of implant revivals.</p>
                    </div>
                  </div>
                </div>
