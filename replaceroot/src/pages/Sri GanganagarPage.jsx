...
const SriGanganagarPage = () => {
  const clinicName = 'sriGanganagar';
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-sri-ganganagar"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
          ...
          {isMobileMenuOpen && (
            <div className="absolute top-full left-0 right-0 bg-white shadow-lg md:hidden">
              <div className="px-6 py-4 space-y-4">
                ...
                <button 
                  onClick={() => setIsContactModalOpen(true)}
                  className="block bg-teal-500 hover:bg-teal-600 text-white font-semibold px-5 py-2 rounded-lg transition text-center w-full"
                >
                  Book Appointment
                </button>
              </div>
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative z-10">
                  <img 
                    src="/images/Sri Ganganagar/B1.webp" 
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 lg:order-1">
                  <div className="relative">
                    <img 
                      src="/images/Sri Ganganagar/B2.webp" 
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <span className="text-xs sm:text-sm">*Prices may vary based on individual case requirements</span>
                                         ...
                                         <button 
                       onClick={() => setIsContactModalOpen(true)}
                       className="inline-flex items-center bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm sm:text-base"
                     >
        ...
        <section id="contact" className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-start max-w-6xl mx-auto">
              {/* Contact Information */}
              ...
              <div className="relative">
                 <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                   ...
                   <button 
                     onClick={() => setIsContactModalOpen(true)}
                     className="w-full bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                   >
                 ...
                 <div className="mt-8 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                   <div className="p-6 sm:p-8">
                     <div className="flex items-center space-x-4 mb-6">
                       ...
                       <div>
                         ...
                         <p className="text-gray-600">Find us easily in {displayName}</p>
                       </div>
                     </div>
                  ...
                  <iframe 
                    ...
                    referrerPolicy="no-referrer-when-downgrade"
                         title={`Dental Clinic Location in ${displayName}`}
                         className="absolute inset-0"
                       ></iframe>
                </div>
                     <div className="mt-4 text-center">
                       <a 
                         href={clinic.contact.mapEmbedUrl.replace('/embed', '/place')}
                         target="_blank"
        ...
        {/* Removed to reorder per /clinic route: Experts, Tourism, Gallery, Why (will be re-added after Pricing) */}
         ...
         <div className="fixed bottom-6 right-6 z-50">
           <button 
             onClick={() => setIsContactModalOpen(true)}
             className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1"
             title="Contact Us"
           >
...
export default SriGanganagarPage;
