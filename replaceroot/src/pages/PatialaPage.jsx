...
const PatialaPage = () => {
  const clinicName = 'patiala';
  const displayName = getDisplayName(clinicName);
  const displayCity = 'Patiala';
  ...
  return (
    <Layout
      ...
      keywords={['dental implants in Patiala', `best dental clinic in ${displayCity}`, 'teeth implants Patiala', 'All-on-4 Patiala', 'affordable dental implants Patiala', 'permanent teeth replacement Patiala', 'ReplaceRoots Patiala']}
      canonical="/dental-implants-patiala"
      og={{
