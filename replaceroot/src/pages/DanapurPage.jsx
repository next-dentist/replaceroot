...
const DanapurPage = () => {
  ...
  const pridePoints = [
    'Using the best range of implant',
    'Using the best local dental masters',
    'Never pliant on the quality of the stock we use',
    'Prime dental Implant treatment',
    'Friendly & Kind staffs',
    'Comfortable & setting',
  ...
  const whyFeatures = [
    {
      ...
      description:
        'Our purpose-designed and custom-built clinic in Danapur lets us provide you best stock Implants in pleasant, comfortable surroundings.'
    },
    {
      icon: 'fa-user-doctor',
      title: 'Most proficient Implant Experts',
      description:
        'All of the dentists at Replace Roots in Danapur are enthusiastic about their work and are serious to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-location-dot',
      title: 'Centrally Located',
      description:
        'Find us quickly and easily. Replace Roots, is in the middle of Danapur in the progressive city Area, within walking distance of near bus stop and other public transports.'
    },
    {
      icon: 'fa-clock',
    ...
    },
    {
      ...
      description:
        'Are of paramount importance at Replace Roots, Danapur. We are beset with cleanliness, have a dedicated decontamination room, and follow rigorous guidelines to ensure patient safety.'
    },
    {
  ...
  const contactPhone = '+91 787 470 0596';
  const contactEmail = 'info@localhost';
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0">
                  Approved ReplaceRoots Dental Implant center in Danapur is the most useful treatment variant for replacing absent teeth. Rather than using traditional denture and next teeth in fixed bridges. We offer the best techniques in Dental implants in the Danapur branch. Whatever the reasons for absent teeth was, Replace Roots dental center could cover the way to a positive new smile.
                </p>
                ...
                <div className="flex items-center justify-center mb-6">
                  ...
                  <div className="relative">
                    <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 inline-block pb-3 relative">
                      At our center at {displayName}, <span className="text-teal-500">we pride ourselves on:</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                  reasons why implant treatment is increasing in <span className="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">{displayName}</span>?
                </h2>
