...
const NagercoilPage = () => {
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-nagercoil"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody>
                      {pricingData.map((item, index) => (
                        <tr
                          key={index}
                          className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${index % 2 === 1 ? 'bg-gray-50/50' : 'bg-white'}`}
                        >
