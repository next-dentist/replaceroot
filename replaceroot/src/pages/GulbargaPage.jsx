...
const GulbargaPage = () => {
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-gulbarga"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
        ...
        <section id="section_1" className="py-24 bg-gradient-to-br from-white to-gray-50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mt-12 sm:mt-16 text-center"><div className="inline-flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4"><div className="flex items-center space-x-2 text-gray-500"><i className="fa-solid fa-check-circle text-cyan-500"></i><span className="text-xs sm:text-sm font-medium">8 Key Advantages</span></div><div className="hidden sm:block w-px h-4 bg-gray-300"></div><div className="flex items-center space-x-2 text-gray-500"><i className="fa-solid fa-award text-cyan-500"></i><span className="text-xs sm:text-sm font-medium">Proven Excellence</span></div></div></div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="mt-12 flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8">
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-trending-up text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">Growing Demand</span>
                  </div>
                  <div className="hidden sm:block w-px h-4 bg-gray-300"></div>
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-users text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">6 Key Factors</span>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                        <div className="flex items-center justify-center lg:justify-start space-x-3 sm:space-x-4 group/item">
                          ...
                          <span className="text-gray-700 font-medium text-sm sm:text-base group-hover/item:text-gray-800 transition-colors">Flexible Scheduling</span>
                        </div>
                        <div className="flex items-center justify-center lg:justify-start space-x-3 sm:space-x-4 group/item">
                          <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-cyan-100 to-teal-100 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform">
                            <i className="fa-solid fa-check text-cyan-600 text-xs sm:text-sm"></i>
                          </div>
                          <span className="text-gray-700 font-medium text-sm sm:text-base group-hover/item:text-gray-800 transition-colors">Expert Consultation</span>
                        </div>
                        <div className="flex items-center justify-center lg:justify-start space-x-3 sm:space-x-4 group/item">
                          <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-cyan-100 to-teal-100 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform">
                            <i className="fa-solid fa-check text-cyan-600 text-xs sm:text-sm"></i>
                          </div>
                          <span className="text-gray-700 font-medium text-sm sm:text-base group-hover/item:text-gray-800 transition-colors">Advanced Treatment Plans</span>
                        </div>
                      </div>
              ...
              <div className="mt-12 sm:mt-16 text-center">
                <div className="inline-flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
                  <div className="flex items-center space-x-2 text-gray-500">
                    ...
                    <span className="text-xs sm:text-sm font-medium">Proven Excellence</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-microchip text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">Advanced Technology</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-calendar-check text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">Easy Scheduling</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="mt-12 sm:mt-16 text-center">
                <div className="inline-flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
                  <div className="flex items-center space-x-2 text-gray-500">
                    ...
                    <span className="text-xs sm:text-sm font-medium">12 Specialties</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-award text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">Premium Care</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-500">
                    <i className="fa-solid fa-heart text-cyan-500"></i>
                    <span className="text-xs sm:text-sm font-medium">Patient Focused</span>
                  </div>
                </div>
              </div>
            </div>
