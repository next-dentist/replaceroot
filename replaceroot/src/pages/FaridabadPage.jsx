...
const FaridabadPage = () => {
  ...
  return (
    <Layout
      ...
      canonical="/dental-implants-faridabad"
      og={{
        title: `Dental Implants in ${displayName} | ReplaceRoots Approved Centre`,
        description: clinicContent.description,
        type: 'website',
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="mt-12 flex justify-center items-center space-x-8">
                  <div className="inline-flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8">
