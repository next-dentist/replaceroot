...
const BhopalPage = () => {
  ...
  return (
    <Layout
      title={`Dental Implants in ${displayName} | Best Implant Clinic in Bhopal | ReplaceRoots`}
      description={`Best dental implants in Bhopal at ReplaceRoots. Pain-free, affordable & permanent teeth replacement solutions. Book a free consultation with our expert dentists today!`}
      keywords={['dental implants in Bhopal', 'best dental clinic in Bhopal', 'teeth implants Bhopal', 'All-on-4 Bhopal', 'affordable dental implants Bhopal', 'permanent teeth replacement Bhopal', 'ReplaceRoots Bhopal']}
      canonical="/dental-implants-bhopal"
      og={{
        title: `Dental Implants in Bhopal | Best Implant Clinic | ReplaceRoots`,
        description: `Get world-class dental implants in Bhopal at ReplaceRoots. Pain-free procedures, affordable pricing, and expert care for permanent teeth replacement solutions.`,
        type: 'website',
