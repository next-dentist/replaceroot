...
const BlogPostBuildingTrust = () => {
  ...
  return (
    <Layout
      title="Building Trust Online: How to Create Compelling Before-and-After Content | ReplaceRoot"
      description="Learn how to showcase your implant work effectively while building patient trust and confidence. Expert tips for creating compelling before-and-after content."
      keywords={['dental marketing', 'before and after content', 'patient trust', 'content marketing', 'dental photography', 'implant marketing', 'digital presence', 'ReplaceRoot']}
      canonical="/blog/building-trust-online"
      og={{
        title: "Building Trust Online: How to Create Compelling Before-and-After Content",
        description: "Learn how to showcase your implant work effectively while building patient trust and confidence. Expert tips for creating compelling before-and-after content.",
        type: 'article',
        image: "https://replaceroot.com/images/blog/before-after-content.jpg",
        article: {
          author: "Dr. Lisa Wang",
          publishedTime: "2024-03-08T00:00:00Z",
          section: "Marketing",
          tag: ["Content Marketing", "Patient Trust", "Before & After", "Digital Presence"]
        }
      }}
      ...
      jsonLd={{
        ...
        '@type': 'BlogPosting',
        headline: 'Building Trust Online: How to Create Compelling Before-and-After Content',
        description: 'Learn how to showcase your implant work effectively while building patient trust and confidence. Expert tips for creating compelling before-and-after content.',
        author: {
          '@type': 'Person',
          name: 'Dr. Lisa Wang'
        ...
        mainEntityOfPage: {
          '@type': 'WebPage',
          '@id': 'https://replaceroot.com/blog/building-trust-online'
        }
      }}
    >
...
export default BlogPostBuildingTrust;
