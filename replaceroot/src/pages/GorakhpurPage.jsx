...
const GorakhpurPage = () => {
  const clinicName = 'gorakhpur';
  const displayName = getDisplayName(clinicName);
  const displayCity = 'Gorakhpur';
  ...
  return (
    <Layout
      title={`Dental Implants in ${displayCity} | Best Implant Clinic | ReplaceRoots`}
      description={`Best dental implants in ${displayCity} at ReplaceRoots. Pain-free, affordable & permanent teeth replacement solutions. Book a free consultation with our expert dentists today!`}
      keywords={['dental implants in Gorakhpur', `best dental clinic in ${displayCity}`, 'teeth implants Gorakhpur', 'All-on-4 Gorakhpur', 'affordable dental implants Gorakhpur', 'permanent teeth replacement Gorakhpur', 'ReplaceRoots Gorakhpur']}
      canonical="/dental-implants-gorakhpur"
      og={{
