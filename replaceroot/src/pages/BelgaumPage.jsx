...
const BelgaumPage = () => {
  ...
  const whyFeatures = [
    {
      ...
      description:
        'Our purpose-designed and custom-built clinic in Belgaum lets us provide you acme resources Implants in pleasant, comfortable surroundings.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Most Implant Experts',
      description:
        'All of the dentists at Replace Roots in Belgaum are devoted about their work and are committed to delivering you premium-quality dentistry.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Centrally Located',
      description:
        'Find us quickly and easily. Replace Roots is in the centre of Belgaum, within walking distance of nearby bus stops and other public transports.'
    },
    {
      icon: 'fa-check-circle',
    ...
    },
    {
      ...
      description:
        'Are of paramount importance at Replace Roots, Belgaum. We are beset with cleanliness, have a dedicated decontamination room, and follow rigorous guidelines to ensure patient safety.'
    },
    {
      icon: 'fa-check-circle',
      title: 'Helpful Staff',
  ...
  const canonicalPath = '/dental-implants-belgaum';
          ...
          <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">{tourism.places.map((p, idx) => (<li key={idx} className="flex items-center"><i className="fa-solid fa-check text-teal-500 mr-2"></i>{p}</li>))}</ul>
              </div>
                ...
                <div className="space-y-8">
                  <div className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <p className="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Credibility and reputation have been achieved through research and variation, service, and quality control. The Replace Roots Centre in Belgaum is widely trusted and may be considered a reference Clinic.</p>
                    </div>
                  </div>
