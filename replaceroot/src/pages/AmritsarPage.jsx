...
const AmritsarPage = () => {
  ...
  return (
    <Layout
      title={`Dental Implants in ${displayName} | Best Implant Clinic in Amritsar | ReplaceRoots`}
      description={`Best dental implants in Amritsar at ReplaceRoots. Pain-free, affordable & permanent teeth replacement solutions. Book a free consultation with our expert dentists today!`}
      keywords={['dental implants in Amritsar', 'best dental clinic in Amritsar', 'teeth implants Amritsar', 'All-on-4 Amritsar', 'affordable dental implants Amritsar', 'permanent teeth replacement Amritsar', 'ReplaceRoots Amritsar']}
      canonical="/dental-implants-amritsar"
      og={{
        title: `Dental Implants in Amritsar | Best Implant Clinic | ReplaceRoots`,
        description: `Get world-class dental implants in Amritsar at ReplaceRoots. Pain-free procedures, affordable pricing, and expert care for permanent teeth replacement solutions.`,
        type: 'website',
