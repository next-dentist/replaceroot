            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 mb-1">Titanium Implant</h4>
                    <p className="text-gray-600">A small, biocompatible post surgically placed into your jawbone that acts as the root of your new tooth.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 mb-1">Abutment</h4>
                    <p className="text-gray-600">A connector piece that attaches to the implant and supports your custom-made crown.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 mb-1">Porcelain Crown</h4>
                    <p className="text-gray-600">A custom-designed, natural-looking tooth that matches your existing teeth perfectly.</p>
                  </div>
                </div>
              </div>
